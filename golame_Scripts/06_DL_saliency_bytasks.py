...
win_len = 60
hop = 25
# model_fname = 'checkpoints/inception_face_60wz_25st_AtaxiavsControl_mask_y_len10_mask_x_len10_lr1e-05_derivTrue_pntsubsetTrue_optimAdam_valBatch8_22-07-20_13-41-31'
model_fname = 'checkpoints/inception_face_60wz_25st_AtaxiavsControl_mask_y_len20_mask_x_len10_lr1e-06_derivTrue_pntsubsetTrue_optimAdam_valBatch8_22-07-20_10-18-11'

# win_len = 200
# hop = 50
# model_fname = 'checkpoints/inception_face_200wz_50st_AtaxiavsControl_mask_y_len20_mask_x_len10_lr1e-06_derivTrue_pntsubsetTrue_optimAdam_valBatch8_22-07-20_09-44-22'
...
msk =np.arange(len(saliences))# correct #   task_id # 
...
axs[2, 0].imshow(saliences[msk].mean(0)[:70])
axs[2, 1].imshow(saliences[msk].mean(0)[70:])

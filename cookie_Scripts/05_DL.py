...
mask_x_len = 50
lr = 1e-6
model_name =   "inception_model1" #"CNN_short_fc_multi" #   "inception_multi"  # "inception"  #"FCNN_short" #  "CNN_short_fc" # 
pose_pnts_small =  "face_mouse" # "mouse" #True #"eyes_mouse" #  or True
derivatives= True
save = True
...
for win_len in [200]:
    for hop in [300]:
        ...
        x_ts_train, x_S_train, y_train, sbj_ids_train, inx_win = get_data(
            data_train, win_len, hop, vad_min, pose_dims=pose_dims, derivatives=derivatives, audio_dims=audio_dims)
        x_ts_val, x_S_val, y_val, sbj_ids_val, _ = get_data(
            data_val, win_len, hop, vad_min, pose_dims=pose_dims, derivatives=derivatives, audio_dims=audio_dims)

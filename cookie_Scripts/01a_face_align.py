...
fname = "Oculomotor_Cookie_Theft_face_dataset_inx_mediapipe.pickle"
...
for k in  list(dataset)[:]:
    ...
    dataset[k]['ts'][mask] = pos_deID

fname = "Oculomotor_Cookie_Theft_face_deID_dataset_inx_mediapipe.pickle"
